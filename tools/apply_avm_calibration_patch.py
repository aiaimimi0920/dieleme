"""Compatibility facade for the split apply_avm_calibration_patch tool."""
...
_IMPLEMENTATION_MODULES = (
    'tools.avm_calibration_context',
    'tools.avm_calibration_payload',
    'tools.avm_calibration_contracts',
    'tools.avm_calibration_playbook',
    'tools.avm_calibration_targets',
    'tools.avm_calibration_service',
    'tools.avm_calibration_cli',
)
_FACADE_CLASS_NAMES = {}
_CLONED_CLASS_NAMES = {}
