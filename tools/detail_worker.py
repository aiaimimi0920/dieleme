"""Compatibility facade for the split detail_worker runtime."""
...
_IMPLEMENTATION_MODULES = (
    'tools.detail_worker_context',
    'tools.detail_worker_config',
    'tools.detail_worker_policy',
    'tools.detail_worker_artifacts',
    'tools.detail_worker_execution',
    'tools.detail_worker_loop',
    'tools.detail_worker_cli',
)
_DIRECT_FUNCTION_ALIASES = {}
_FACADE_CLASS_NAMES = {'DetailWorkerConfig'}
