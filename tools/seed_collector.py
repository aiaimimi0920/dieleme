"""Compatibility facade for the split seed_collector runtime."""
...
_IMPLEMENTATION_MODULES = (
    'tools.seed_collector_context',
    'tools.seed_collector_config',
    'tools.seed_collector_queue',
    'tools.seed_collector_auth',
    'tools.seed_collector_progress',
    'tools.seed_collector_cycle',
    'tools.seed_collector_loop',
    'tools.seed_collector_cli',
)
_DIRECT_FUNCTION_ALIASES = {}
_FACADE_CLASS_NAMES = {'SeedCollectorConfig', 'SeedScanJobSpec', 'SeedSortSpec'}
