"""Compatibility facade for the split taobao_login_health runtime."""
...
_IMPLEMENTATION_MODULES = (
    'tools.taobao_health_context',
    'tools.taobao_health_classification',
    'tools.taobao_health_cdp_transport',
    'tools.taobao_health_captcha',
    'tools.taobao_health_cdp_session',
    'tools.taobao_health_probe',
    'tools.taobao_health_cli',
)
_DIRECT_FUNCTION_ALIASES = {'_auth_page_lock'}
_FACADE_CLASS_NAMES = {}
